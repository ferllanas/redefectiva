				...
				<form class="pb-4 needs-validation" novalidate action="#" id="form-nalumno">
				  ...
				  <fieldset class="pb-4">
				    <div class="form-label-group mb-3">
					    ...
					    <input type="number" id="matricula" name="matricula" class="form-control" placeholder="Ej. 452865" min="1" max="999999999999" required>
				    ...
				    <div class="form-label-group mb-3">
				      ...
				      <input type="text" id="nombre" name="nombre" minlength="3" maxlength="70" class="form-control" placeholder="Ej. Edilberto" required>
				      <div class="invalid-feedback">
				    ...
				    <div class="form-label-group mb-3">
				      ...
				      <input type="text" id="appat" name="appat" minlength="3" maxlength="40" class="form-control" placeholder="Ej. Llanas" required>
				      <div class="invalid-feedback">
				    ...
				    <div class="form-label-group mb-3">
				      ...
				      <input type="text" id="apmat" name="apmat" minlength="3" maxlength="40" class="form-control" placeholder="Ej. Martinez" required>
				      <div class="invalid-feedback">
				    ...
				    <div class="form-label-group mb-3">
				      ...
				      <input type="date" id="fecnac" name="fecnac" class="form-control" pattern="^([0-2][0-9]||3[0-1])/(0[0-9]||1[0-2])/([0-9][0-9])?[0-9][0-9]$" placeholder="2021/04/19" required>
				      <div class="invalid-feedback">
				    ...
				    <div class="form-label-group mb-3">
				      ...
				      <input type="number" min="1" max="6" step="1" value="1" id="grado" name="grado" class="form-control" placeholder="Ej. 1" required>
				      <div class="invalid-feedback">
